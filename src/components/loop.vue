<template>
  <div class="spon subMain" :class="{isChild}">
    ...
    <Table :loading="tabLoading" border :columns="apis[apiName].columns" :data="dataList">
  ...
  data() {
    return {
      ...
      apis: {
        iotcomm: {
          add: "/loop/addByCom",
          delete: "/loop/deleteByCom/",
          update: "/loop/updateByCom",
          query: "/loop/findByCom",
          columns: [
            {
              key: "id",
              title: "id"
            ...
            },
            {
              ...
              //   var self = this;
              //   var gatewayName = "";
              //   var gateway = self.gateways.find(
              //     g => g.id == param.row.gatewayId
              //   );

              //   return h("div", gateway ? gateway.name : param.row.gatewayId);
              // }
            },
            {
              key: "breakerId",
            ...
            {
              key: "breakerModuleName",
              title: "开关模块"
            },
            {
              key: "breakerModuleRemark",
              title: "开关模块备注"
            },
            {
              key: "ccuUid",
        ...
        shuncom: {
          add: "/loop/addByShun",
          delete: "/loop/deleteByShun/",
          update: "/loop/updateByShun",
          query: "/loop/findByShun",
          columns: [
            {
              key: "id",
              title: "id"
